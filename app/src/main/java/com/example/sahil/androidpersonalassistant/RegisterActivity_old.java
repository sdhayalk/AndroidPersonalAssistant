...
public class RegisterActivity_old extends AppCompatActivity {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(usernameEditText.getText().toString().equals("")||emailEditText.getText().toString().equals("") || passwordEditText.getText().toString().equals("")) {
                    Toast.makeText(RegisterActivity_old.this, "Please enter all fields!", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(!passwordEditText.getText().toString().equals(rePasswordEditText.getText().toString())){
                    Toast.makeText(RegisterActivity_old.this, "Password do not match!", Toast.LENGTH_SHORT).show();
                }
                else {
                    if(!isValidEmail(emailEditText.getText().toString())){
                        Toast.makeText(RegisterActivity_old.this, "Invalid Email!", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    editor.commit();
                    Intent intent = new Intent(RegisterActivity_old.this, LoginActivity.class);
